  ...
  return (
    ...
    <ul>
      ...
      {todoListInfo.map((individual, index) => { 
        ...
        return <TodoEditDeleteFormTag key={index} listId={individual.id} whatTodo={individual.todo} isChecked={individual.isCompleted} readTodoFunction={readTodoFunction}/>
