    ...
    <div style={{marginRight:"5%"}}>
      <ul>
        ...
        {todoListInfo.map((individual) => { 
          ...
          return <TodoUpdateDeleteFormDetails key={individual.id} listId={individual.id} whatTodo={individual.todo} isChecked={individual.isCompleted} readTodoFunction={readTodoFunction}/>
